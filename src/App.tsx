...
const Riscos = React.lazy(() =>
  import("@/pages/Riscos").then((m) => ({ default: m.Riscos })),
);
...
const ContasPrivilegiadas = React.lazy(
  () => import("@/pages/ContasPrivilegiadas"),
);
...
const DenunciaFormulario = React.lazy(
  () => import("@/pages/DenunciaFormulario"),
);
...
const SolicitacaoPrivacidadePublica = React.lazy(
  () => import("@/pages/SolicitacaoPrivacidadePublica"),
);
          ...
          <AuthProvider>
              ...
              <DocGenProvider>
                <ErrorBoundary>
                  <Routes>
                    ...
                    <Route
                      path="/due-diligence/responder/:token"
                      element={<AssessmentLinkRedirect />}
                    />
                    <Route
                      path="/dd/responder/:token"
                      element={<AssessmentLinkRedirect />}
                    />
                    <Route
                      path="/denuncia/externa/:token"
                      element={
                        <Suspense fallback={<RouteFallback />}>
                          <DenunciaExternaRedirect />
                        </Suspense>
                      }
                    />
                    <Route
                      path="/:empresa/denuncia"
                      element={
                        <Suspense fallback={<RouteFallback />}>
                          <DenunciaMenu />
                        </Suspense>
                    ...
                    />
                    <Route
                      path="/:empresa/denuncia/registrar"
                      element={
                        <Suspense fallback={<RouteFallback />}>
                          <DenunciaFormulario />
                        </Suspense>
                    ...
                    />
                    <Route
                      path="/:empresa/denuncia/consulta"
                      element={
                        <Suspense fallback={<RouteFallback />}>
                          <DenunciaConsulta />
                        </Suspense>
                    ...
                    />
                    <Route
                      path="/solicitacao-privacidade/:slug"
                      element={
                        <Suspense fallback={<RouteFallback />}>
                          <SolicitacaoPrivacidadePublica />
                        </Suspense>
                      }
                    />
                    <Route
            ...
            */}
                    <Route element={<AuthenticatedShell />}>
                      ...
                      />
                      <Route
                        path="/gap-analysis/framework/:frameworkId"
                        element={
                          <ProtectedRoute
                            moduleName="gap-analysis"
                            fallbackToRoleCheck={false}
                      ...
                      />
                      <Route
                        path="/contas-privilegiadas"
                        element={
                          <ProtectedRoute
                            moduleName="contas-privilegiadas"
                            fallbackToRoleCheck={false}
                          >
                            <ContasPrivilegiadas />
                          </ProtectedRoute>
                    ...
                    <Route
                      path="/riscos/aceite"
                      element={<Navigate to="/riscos?view=aceite" replace />}
                    />
                    <Route
                      path="/gap-analysis"
                      element={
                    ...
                    />
                    <Route
                      path="/gap-analysis/avaliacao-aderencia"
                      element={
                        <Navigate to="/gap-analysis/frameworks" replace />
                      }
                    />
                    <Route
                      path="/controles"
                      element={<Navigate to="/governanca/controles" replace />}
                    />
                    <Route
                      path="/auditorias"
                      element={<Navigate to="/governanca/auditorias" replace />}
                    />
                    <Route
                      path="/dados"
