  ...
  lgpd: {
    ...
    perguntas: [
      ...
      },
      {
        ...
        codigos: ['Art. 26', 'Art. 27', 'Art. 28'],
        justificativa: 'A organização é pessoa jurídica de direito privado e não integra a administração pública direta ou indireta. Não recebe de órgãos ou entidades do Poder Público, por convênio, contrato administrativo ou participação em programa governamental, bases de dados pessoais, e não realiza uso compartilhado de dados pessoais na execução de políticas públicas. Por essa razão não lhe são exigíveis: o uso compartilhado de dados pelo Poder Público vinculado a finalidades específicas de políticas públicas e a atribuição legal dos órgãos públicos (Art. 26), a informação à autoridade nacional sobre comunicação ou uso compartilhado de dados de pessoa jurídica de direito público para pessoa de direito privado (Art. 27), a publicação de informações sobre uso compartilhado quando solicitada pela autoridade nacional a órgãos e entidades do poder público (Art. 28) e a publicação de relatório de impacto à proteção de dados pessoais por pessoa jurídica de direito público (Art. 31). Caso a organização venha a firmar convênio ou contrato que envolva a cessão de bases de dados pessoais por ente público, estes artigos retornarão ao escopo.',
      ...
      },
      {
        ...
        codigos: ['Art. 55-B', 'Art. 55-C', 'Art. 55-D'],
        justificativa: 'Os artigos 55-B, 55-C e 55-D da Lei nº 13.709/2018 disciplinam a composição interna, a autonomia técnica e decisória e o Conselho Diretor da Autoridade Nacional de Proteção de Dados, e os artigos 56 a 59 tratam da competência regulamentar do Poder Executivo, da revogação de dispositivos de outras leis e da entrada em vigor da própria Lei. Nenhum desses dispositivos dirige obrigação, veda conduta ou exige controle, política ou registro do agente de tratamento. A organização não integra a estrutura da autoridade nacional e, não havendo medida a implementar nem evidência que possa ser produzida sobre esses artigos, eles são registrados como Não Aplicáveis, sem prejuízo da observância integral da Lei, já plenamente vigente, cujas obrigações são avaliadas nos demais artigos deste escopo.',
