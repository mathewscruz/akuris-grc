...
const ptDict = {
  ...
  reviewExterna: {
    ...
    loadError: 'Não foi possível carregar esta revisão. Verifique o link ou solicite um novo convite.',
  ...
  denunciaMenu: {
    ...
    unavailableDescription: 'Esta empresa ainda não ativou o canal de denúncias. Entre em contato com a organização por outro meio seguro.',
  ...
  assessment: {
    ...
    errorCompletedTitle: 'Questionário já concluído',
    errorCompletedMessage: 'As respostas deste questionário já foram enviadas. Não é necessário responder novamente.',
...
const enDict: typeof ptDict = {
  ...
  reviewExterna: {
    ...
    loadError: 'This review could not be loaded. Check the link or request a new invitation.',
  ...
  denunciaMenu: {
    ...
    unavailableDescription: 'This company has not activated its whistleblower channel yet. Contact the organization through another secure channel.',
  ...
  denunciaForm: {
    ...
    etapa2: 'Identification',
    etapa3: 'Additional information',
  ...
  assessment: {
    ...
    errorCompletedTitle: 'Questionnaire already completed',
    errorCompletedMessage: 'The responses to this questionnaire have already been submitted. You do not need to answer again.',
