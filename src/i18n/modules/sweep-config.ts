  ...
  pt: {
    sweepConfig: {
      traducaoFrameworks: {
        ...
        progressLine: '{traduzidos} de {total} requisitos · orientações PT: {guidancePt} · EN: {guidanceEn} (de {total})',
  ...
  en: {
    sweepConfig: {
      traducaoFrameworks: {
        ...
        progressLine: '{traduzidos} of {total} requirements · guidance PT: {guidancePt} · EN: {guidanceEn} (of {total})',
