...
const PT = {
  ...
  confirmarTudoAplicavel: 'Confirmar escopo',
  ...
  confirmarSemExclusoes: 'Nenhum requisito será excluído. Os {total} permanecem no escopo da sua empresa.',
  ...
  gravadoSemExclusoes: 'Escopo confirmado: todos os requisitos permanecem aplicáveis.',
...
const EN: typeof PT = {
  ...
  confirmarTudoAplicavel: 'Confirm scope',
  ...
  confirmarSemExclusoes: 'No requirement will be excluded. All {total} remain in your company scope.',
  ...
  gravadoSemExclusoes: 'Scope confirmed: all requirements remain applicable.',
