  ...
  pt: {
    govDialogs: {
      itemAuditoriaFormDialog: {
        ...
        toastNotificationWarning: 'Item salvo, mas o e-mail não foi confirmado',
        toastNotificationWarningDescription: 'Confira a configuração de e-mail e tente atribuir o responsável novamente.',
  ...
  en: {
    govDialogs: {
      itemAuditoriaFormDialog: {
        ...
        toastNotificationWarning: 'Item saved, but the email was not confirmed',
        toastNotificationWarningDescription: 'Check the email configuration and assign the responsible person again.',
